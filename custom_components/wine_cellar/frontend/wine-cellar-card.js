...
let CabinetGrid = class CabinetGrid extends i {
    ...
    _bottleGlyph(uid) {
        const body = "M 3 62 L 3 12 A 47 8 0 0 1 97 12 L 97 62" +
      ...
      <svg class="bottle-glyph" viewBox="-8 0 116 104"
        ...
        <defs>
          <linearGradient id="wcb-${uid}" x1="0" x2="1" y1="0" y2="0">
            <stop offset="0%" style="stop-color: color-mix(in srgb, ${w$1} 6%, #04060a)" />
            <stop offset="14%" style="stop-color: color-mix(in srgb, ${w$1} 24%, #171d14)" />
            <stop offset="27%" style="stop-color: color-mix(in srgb, ${w$1} 40%, #333d2c)" />
            <stop offset="46%" style="stop-color: color-mix(in srgb, ${w$1} 27%, #1a2116)" />
            <stop offset="80%" style="stop-color: color-mix(in srgb, ${w$1} 13%, #0b0f08)" />
            <stop offset="100%" style="stop-color: color-mix(in srgb, ${w$1} 5%, #04060a)" />
          </linearGradient>
          ...
          <linearGradient id="wcc-${uid}" x1="0" x2="1" y1="0" y2="0">
            <stop offset="0%" style="stop-color: color-mix(in srgb, ${w$1} 44%, #000)" />
            <stop offset="26%" style="stop-color: color-mix(in srgb, ${w$1} 92%, #fff)" />
            <stop offset="58%" style="stop-color: ${w$1}" />
            <stop offset="100%" style="stop-color: color-mix(in srgb, ${w$1} 38%, #000)" />
          </linearGradient>
        ...
        <path d="${body}" fill="url(#wcb-${uid})"
              style="stroke: ${w$1}" stroke-opacity="0.45" stroke-width="1.2" />
